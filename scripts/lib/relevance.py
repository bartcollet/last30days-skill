...
Ported verbatim from upstream (mvanhorn/last30days-skill) for the keyless
HN/GitHub/Polymarket sources, which use this heuristic instead of an LLM
relevance pass (keeps them cost-free and fast). Self-contained: only depends
on `re`/`typing`.
"""
